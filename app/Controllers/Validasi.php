...
class Validasi extends BaseController
{
    ...
    public function gambartext()
    {
        $data = [
            'title' => 'Validation image Page',
            'validation' => \Config\Services::validation()
        ];

        return view('/validasi/gambartext', $data);
    }
    ...
    //         shell_exec('"C:\\Program Files (x86)\\Tesseract-OCR\\tesseract" "C:\\xampp\\htdocs\\TA_SistemValidasi\\images\\' . $file_name . '" out');
    ...
    //         echo "</pre>";
    //     }
    //     return redirect()->to('/validasi/gambartext')->withInput();
    // }
}
