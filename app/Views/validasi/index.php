                        ...
                        <div class="d-flex flex-row-reverse bd-highlight">
                            <form action="" method="post">
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-light" type="submit" id="button-addon2" name="submit"><i class="bi bi-search"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm offset-sm-0">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-borderless" style="width:180px; table-layout:auto">
